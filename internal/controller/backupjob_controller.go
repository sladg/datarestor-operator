...
// NewBackupJobReconciler creates a new BackupJobReconciler
func NewBackupJobReconciler(client client.Client, scheme *runtime.Scheme, typedClient kubernetes.Interface) *BackupJobReconciler {
...
// +kubebuilder:rbac:groups=backup.autorestore-backup-operator.com,resources=backupjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.autorestore-backup-operator.com,resources=backupjobs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=backup.autorestore-backup-operator.com,resources=backupjobs/finalizers,verbs=update
